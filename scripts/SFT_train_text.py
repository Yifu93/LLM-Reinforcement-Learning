# This script is used to train the model using supervised fine-tuning (SFT) on text data.
# without using LoRA.
...
def main():
    ...
    dataset_test_path = "./data/smoltalk/test"
    ...
    train_dataset = get_smoltalk_dataset(dataset_path)
    test_dataset = get_smoltalk_dataset(dataset_test_path)
    print(f"Total samples: {len(train_dataset)}")

    # Training arguments (no validation)
    training_args = TrainingArguments(
        output_dir="./sft_qwen_text",
    ...
    trainer.save_model("./checkpoints/sft_qwen_math_text")
    tokenizer.save_pretrained("./checkpoints/sft_qwen_math_text")
