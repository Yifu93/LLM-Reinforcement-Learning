...
def main():
    model_path = "checkpoints/sft_qwen_text_full"
    ...
    trainer.save_model("./checkpoints/SFT_qwen_math_fulltext")
    tokenizer.save_pretrained("./checkpoints/SFT_qwen_math_fulltext")
