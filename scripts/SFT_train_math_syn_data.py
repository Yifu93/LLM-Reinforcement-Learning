...
from scripts.dataloader import get_math_syn_dataset
...
def main():
    ...
    dataset_path = "./data/synthetic_data/all_math.json"
    ...
    # Load dataset
    train_dataset = get_math_syn_dataset(dataset_path)
    ...
    trainer.save_model("./checkpoints/SFT_qwen_math_syn")
    tokenizer.save_pretrained("./checkpoints/SFT_qwen_math_syn")
