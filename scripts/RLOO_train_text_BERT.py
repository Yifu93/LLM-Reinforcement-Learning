...
REWARD_MODEL_PATH = "checkpoints/reward/BERT"
DATA_PATH = "./data/ultrafeedback_binarized/train_gen"
OUTPUT_DIR = "./checkpoints/RLOO_ultrafeedback_BERT"
MAX_LENGTH = 1024
BATCH_SIZE = 4
...
def main():
    ...
    reward_model_raw = AutoModelForSequenceClassification.from_pretrained("checkpoints/reward/BERT")
    reward_tokenizer = AutoTokenizer.from_pretrained("checkpoints/reward/BERT")
